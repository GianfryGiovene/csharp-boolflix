...
namespace BoolFlix.Controllers
{
    public class FilmsController : Controller
    {
        ...
        {
            var boolflixContext = _context.Films.Include(f => f.Genre);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Duration,IsNew,PictureURL,GenreId")] Film film)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Duration,IsNew,PictureURL,GenreId")] Film film)
        {
            if (id != film.Id)
            {
                return NotFound();
